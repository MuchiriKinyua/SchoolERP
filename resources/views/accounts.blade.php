...
<div class="container">
    ...
    <ul class="nav nav-tabs" id="transactionTabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="b2c-tab" data-toggle="tab" href="#b2c" role="tab" aria-controls="b2c" aria-selected="false">B2C</a>
        </li>
        <li class="nav-item">
    ...
    <div class="tab-content mt-3" id="transactionTabContent">
        ...
        <div class="tab-pane fade" id="b2c" role="tabpanel" aria-labelledby="b2c-tab">
            <form action="{{ route('payments.b2c') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="b2c_phone">Phone Number</label>
                    <input type="tel" class="form-control" id="b2c_phone" name="phone" required>
                </div>
                <div class="form-group">
                    <label for="b2c_account_number">Account Number</label>
                    <input type="text" class="form-control" id="b2c_account_number" name="account_number" required>
                </div>
                <div class="form-group">
                    <label for="b2c_amount">Amount</label>
                    <input type="number" class="form-control" id="b2c_amount" name="amount" required>
                </div>
                <button type="submit" class="btn btn-primary">Pay</button>
            </form>
        </div>
